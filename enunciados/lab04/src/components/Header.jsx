...
export function Header({ status, onPrint }) {
  return (
    <header className="border-b border-slate-200 bg-white print:static">
      <div className="mx-auto max-w-7xl px-4 py-3 sm:px-6 lg:px-8 print:max-w-none print:px-0 print:py-2">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={onPrint}
              className="no-print inline-flex items-center gap-1.5 rounded bg-slate-900 px-3 py-1.5 text-xs font-medium text-white transition hover:bg-slate-700"
            >
